...
public class TopologyAppCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(TopologyAppCliTestCommand.class);
    protected final TopologyAppCliCommands service;

    public TopologyAppCliTestCommand(final TopologyAppCliCommands service) {
