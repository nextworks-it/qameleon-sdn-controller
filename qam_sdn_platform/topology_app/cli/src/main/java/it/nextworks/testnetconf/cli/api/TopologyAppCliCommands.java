 ...
 */
package it.nextworks.testnetconf.cli.api;


public interface TopologyAppCliCommands {
    ...
    Object getTopology(String topologyName);
    Object getNodes(String topologyName);
}
