 ...
 */
struct ns_pair namespace_mapping[] = {{"sbvt", "http://org/nextworks/qameleon/sbvt"}, {NULL, NULL}};
...
int callback_sbvt_sbvt(void **data, XMLDIFF_OP op, xmlNodePtr old_node, xmlNodePtr new_node, struct nc_err **error) {
...
struct transapi_data_callbacks clbks =  {
	...
	.callbacks = {
		...
		{.path = "/sbvt:sbvt", .func = callback_sbvt_sbvt}
	}
};
