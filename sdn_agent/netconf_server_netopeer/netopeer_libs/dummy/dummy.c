 ...
 */
struct ns_pair namespace_mapping[] = {{"dummy", "http://org/nextworks/qameleon/dummy"}, {NULL, NULL}};
...
int callback_dummy(void **data, XMLDIFF_OP op, xmlNodePtr old_node, xmlNodePtr new_node, struct nc_err **error) {
...
struct transapi_data_callbacks clbks =  {
	...
	.data = NULL,
	.callbacks = {
		{.path = "/dummy:dummy", .func = callback_dummy}
	}
};
